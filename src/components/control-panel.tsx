...
export function ControlPanel() {
  ...
  const initialValues = {
    ...
    c1: parameters.dampers[0],
    c2: parameters.dampers[1],
    c3: parameters.dampers[2],
  ...
  const [controls, setControlValues] = useControls("Parámetros", () => ({
    "Sistema físico": folder({
      ...
      c1: { value: initialValues.c1, min: 0, max: 10, step: 0.1 },
      c2: { value: initialValues.c2, min: 0, max: 10, step: 0.1 },
      c3: { value: initialValues.c3, min: 0, max: 10, step: 0.1 },
    }),
  ...
  useEffect(() => {
    ...
    setParameters({
      ...
      dampers: [controls.c1, controls.c2, controls.c3],
    });
